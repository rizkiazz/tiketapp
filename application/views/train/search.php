              ...
              <tbody>
                ...
                if(empty($berangkat)){
                  ...
                  <tr>
                    ...
                    <td style="text-align:center">
                      <span class="price blue-text darken-text-5"><?=rupiah($b->price)?></span>
                      <a id="b<?=$b->id_rute?>" onclick="addCart(<?=$b->id_rute?>,<?=$ps?>)" style="width: 100%" class="btn blue pilih_b">Pilih</a>
                    </td>
                  </tr>
                  <?php }
                } ?>
              ...
              <tbody>
                ...
                if(empty($pulang)){
                  ...
                  <tr>
                    ...
                    <td style="text-align:center">
                      <span class="price blue-text darken-text-5"><?=rupiah($b->price)?></span>
                      <a id="p<?=$b->id_rute?>" onclick="addCart(<?=$b->id_rute?>,<?=$ps?>)" style="width: 100%" class="btn blue pilih_p">Pilih</a>
                    </td>
                  </tr>
                  <?php }
                } ?>
