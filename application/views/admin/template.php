...
<head>
  <title><?= $title ?></title>
  <link rel="icon" type="image/x-icon" href="<?= base_url() . "assets/" ?>images/iconapp.ico">
...
<body>
    ...
    <nav class="nav-material grey lighten-5">
      <div class="nav-wrapper">
        <a style="padding-left: 20px;padding-top: 3px" href="#!" class="hide-lg brand-logo">
          <img class="img-brand" src="<?= base_url() . "assets/" ?>images/logo1.png">
        </a>
  ...
  <footer class="page-footer">
    <div class="footer-copyright blue">
      <div class="container">
        <span>Copyright &copy; 2020 <a class="grey-text text-lighten-4" href="<?= base_url() ?>" target="_blank"></a></span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="<?=base_url()?>">Akun Saya</a></span>
      </div>
    </div>
  </footer>
