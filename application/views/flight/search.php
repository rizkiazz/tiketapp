<main>
  <div class="page-header orange darken-4 white-text">
    <h4 class="light">Hasil Pencarian Pesawat</h4>
  </div>
    ...
    <div class="row"> 
      ...
      <div style="display: <?php if(!empty($_SESSION['cart'])){echo "block";}else{echo "none";} ?>" id="orderBtn">
        <div class="fixed-action-btn">
          <a id="btnPesan" href="#confirm" class="btn btn-large orange darken-4 animated modal-trigger">
                ...
                <tr>
                  ...
                  <td style="text-align:center">
                    ...
                    <?php if(!empty($_SESSION['cart'])){
                      ...
                      ?>
                      <a id="b<?=$b->id_rute?>" onclick="<?=$onclick?>(<?=$b->id_rute?>,<?=$ps?>)" style="width: 100%" class="btn orange darken-4 pilih<?=$disabled?>"><?=$text?></a>
                      <?php }else{
                        ?>
                        <a id="b<?=$b->id_rute?>" onclick="addCart(<?=$b->id_rute?>,<?=$ps?>)" style="width: 100%" class="btn orange darken-4 pilih">Pilih</a>
                        <?php
                      } ?>
                    </td>
                  </tr>
      ...
      <?php }else{
        ...
        <div style="display: none" id="orderBtn">
          <div class="fixed-action-btn">
            <a id="btnPesan" href="#confirm" class="btn btn-large orange darken-2 animated modal-trigger">
              <i class="large material-icons inline-text">shopping_cart</i> Pesan Tiket
            </a>
          </div>
        </div>
